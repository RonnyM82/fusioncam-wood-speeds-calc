...
| An advanced box at 0 or below (settled in step 2) | Claude's, 2026-09-24: unchanged. The advanced fields carry no range, so 0 is not refused by the box, and the machine preset serves, as before. Whether they should carry a range is a question for Scott, not part of the conversion. |
